...
export const isKeyword = makePredicate(
  "break case catch continue debugger default do else finally for function if return switch throw try var while with null true false instanceof typeof void secret delete new in this let const class extends export import yield super",
);
